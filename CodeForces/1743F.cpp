...
void build(){
    ...
    lazy[2*maxn-1][0][0] = 332748118;
    lazy[2*maxn-1][0][1] = 332748118;
    lazy[2*maxn-1][1][0] = 665496236;
    lazy[2*maxn-1][1][1] = 665496236;
}
/*
a b x 3 1 = 1 1
c d   0 2   2 2
